...
import EmojiEventsOutlinedIcon from 'src/icons/untitled-ui/duocolor/events';
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: t(tokens.nav.players),
            path: paths.dashboard.players.index,
            icon: (
              <SvgIcon fontSize="small">
                <Users03Icon />
              </SvgIcon>
            ...
            items: [
              ...
              {
                title: t(tokens.nav.details),
                path: paths.dashboard.players.details,
              },
              {
                title: t(tokens.nav.edit),
                path: paths.dashboard.players.edit,
              },
            ],
          },
          {
          title: t(tokens.nav.tournaments),
            path: paths.dashboard.tournaments.index,
            icon: (
              <SvgIcon fontSize="small">
                <CalendarIcon />
              </SvgIcon>
            ...
            items: [
              ...
              {
                title: t(tokens.nav.details),
                path: paths.dashboard.tournaments.details,
              },
              {
                title: t(tokens.nav.edit),
                path: paths.dashboard.tournaments.edit,
              },
            ],
          },
          /* {
