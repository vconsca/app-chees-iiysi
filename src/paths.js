export const paths = {
  ...
  dashboard: {
    ...
    players: {
      index: '/dashboard/players',
      details: '/dashboard/players/:playerId',
      edit: '/dashboard/players/:playerId/edit',
    },
    tournaments: {
      index: '/dashboard/tournaments',
      details: '/dashboard/tournaments/:tournamentId',
      edit: '/dashboard/tournaments/:tournamentId/edit',
    },
